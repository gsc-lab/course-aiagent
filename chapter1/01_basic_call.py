...
#   - model (필수): 사용할 모델 ID
#       - "claude-sonnet-4-20250514": 속도와 성능의 균형 (가장 많이 사용)
#       - "claude-haiku-4-5-20251001": 빠르고 저렴, 간단한 작업에 적합
#       - "claude-opus-4-20250514": 최고 성능, 복잡한 추론에 적합
#   - max_tokens (필수): 모델이 생성할 최대 출력 토큰 수
#   - messages (필수): 대화 메시지 리스트
#       - role: "user"(사용자) 또는 "assistant"(AI) - 대화 순서를 구분
#       - content: 메시지 내용 (문자열 또는 콘텐츠 블록 리스트)
...
#       - content[0].type: 블록 타입 ("text" 또는 "tool_use")
